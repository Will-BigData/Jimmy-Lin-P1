...
def create_user_info_frame(parent, changeScreen):
    """Create a user info frame that displays username, email, and funds."""
    # Create a new frame
    ...
    funds_entry = tk.Entry(user_info_frame, width=10, font=button_font)
